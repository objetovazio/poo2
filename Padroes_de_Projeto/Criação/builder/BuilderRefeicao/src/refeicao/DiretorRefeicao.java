...
public class DiretorRefeicao {        
    ...
    public Refeicao preparaNaoVegetariana(String sabor, String tipoBebida, boolean querBatata){       
        ...
        if(querBatata) refeicaoBuilder.preparaBatata();
        
        refeicaoBuilder.prepadaHamburgerCarne();
        
        return novaRefeicao;        
    }     
    public Refeicao preparaVegetariana(String sabor, String tipoBebida, boolean querBatata){        
        Refeicao novaRefeicao = new Refeicao();
